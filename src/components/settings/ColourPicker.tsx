  ...
  return (
    <div className="absolute inset-0 z-30 flex items-center justify-center p-4">
      ...
      <div
        ...
        className={`groove-surface groove-halo relative flex max-h-full w-full max-w-[308px] flex-col overflow-hidden rounded-lg ring-1 ring-[var(--color-edge)] transition-all duration-[180ms] ease-out ${
