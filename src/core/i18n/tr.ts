...
export const tr: Partial<Record<keyof typeof en, string>> = {
  ...
  'playlists.addedTo': '{name} listesine eklendi',
  'playlists.alreadyIn': 'Zaten {name} listesinde',
  'playlists.couldNotAdd': '{name} listesine eklenemedi',
  'playlists.couldNotCreate': 'Bu liste oluşturulamadı.',
  'playlists.sectionGroovium': 'Groovium’da',
  'playlists.sectionSpotify': 'Spotify’da',
  'playlists.newSpotify': 'Yeni Spotify listesi',
  'playlists.localNotOnSpotify': 'Bilgisayarınızdaki şarkılar Spotify listelerine eklenemez.',
  ...
  'spotify.editSongs': 'Şarkıları düzenle',
  'spotify.alreadyHere': 'Zaten var',
  'spotify.newPlaylist': 'Yeni liste',
  'spotify.done': 'Bitti',
  'spotify.playlistName': 'Liste adı',
  'spotify.changeCover': 'Kapağı değiştir',
  'spotify.coverTitle': 'Yeni kapak',
  'spotify.coverHint': 'Resmi kaydırmak için sürükleyin. Yakınlaştırmak için tekerleği ya da çubuğu kullanın.',
  'spotify.coverZoom': 'Yakınlaştır',
  'spotify.coverUpload': 'Yükle',
  'spotify.coverUnsupported': 'JPEG, PNG ya da WebP bir resim seçin.',
  'spotify.coverTooLarge': 'Bu resim 20 MB’tan büyük.',
  'spotify.coverUnreadable': 'Bu resim okunamadı.',
  'spotify.coverTooBig': 'Bu resim Spotify için yeterince küçültülemedi.',
  'spotify.details': 'Ayrıntılar',
  'spotify.detailsTitle': 'Liste ayrıntıları',
  'spotify.description': 'Açıklama',
  'spotify.public': 'Profilimde göster',
  'spotify.publicHint': 'Herkese açık listeler Spotify profilinizde herkese görünür.',
  'spotify.removeFromLibrary': 'Kitaplıktan kaldır',
  'spotify.removeConfirmTitle': '“{name}” kitaplığınızdan kaldırılsın mı?',
  'spotify.removeConfirmBody': 'Spotify kitaplığınızdan kaybolur. 90 gün boyunca spotify.com’daki hesap sayfanızdan geri getirebilirsiniz.',
  'spotify.removeSong': 'Listeden çıkar',
  'spotify.removeCopies': '{count} kopyanın hepsini çıkar',
  'spotify.editCapped': 'Burada yalnızca ilk 300 şarkı düzenlenebilir.',
