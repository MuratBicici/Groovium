...
export const en = {
  ...
  'spotify.coverHint': 'Drag to move the picture. Scroll or use the slider to zoom.',
  'spotify.coverZoom': 'Zoom',
  'spotify.coverUpload': 'Upload',
  'spotify.coverUnsupported': 'Choose a JPEG, PNG or WebP picture.',
  'spotify.coverTooLarge': 'That picture is larger than 20 MB.',
  'spotify.coverUnreadable': 'That picture could not be read.',
  'spotify.coverTooBig': 'That picture could not be made small enough for Spotify.',
  'spotify.details': 'Details',
  'spotify.detailsTitle': 'Playlist details',
  'spotify.description': 'Description',
  'spotify.public': 'Show on my profile',
  'spotify.publicHint': 'Public playlists appear on your Spotify profile for anyone to see.',
  'spotify.removeFromLibrary': 'Remove from library',
  'spotify.removeConfirmTitle': 'Remove “{name}” from your library?',
  'spotify.removeConfirmBody': 'It disappears from your Spotify library. For 90 days you can bring it back from your account page on spotify.com.',
  'spotify.removeSong': 'Remove from playlist',
  'spotify.removeCopies': 'Remove all {count} copies',
  'spotify.editCapped': 'Only the first 300 songs can be edited here.',
